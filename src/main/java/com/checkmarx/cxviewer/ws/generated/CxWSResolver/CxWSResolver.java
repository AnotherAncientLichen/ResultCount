 ...
 * 
 */
@WebServiceClient(name = "CxWSResolver", targetNamespace = "http://Checkmarx.com", wsdlLocation = "http://10.0.0.21/CxWebInterface/CxWSResolver.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://10.0.0.21/CxWebInterface/CxWSResolver.asmx?wsdl");
     ...
     *     returns CxWSResolverSoap
     */
    @WebEndpoint(name = "CxWSResolverSoap12")
    public CxWSResolverSoap getCxWSResolverSoap12() {
        return super.getPort(new QName("http://Checkmarx.com", "CxWSResolverSoap12"), CxWSResolverSoap.class);
    }
     ...
     */
    @WebEndpoint(name = "CxWSResolverSoap12")
    public CxWSResolverSoap getCxWSResolverSoap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://Checkmarx.com", "CxWSResolverSoap12"), CxWSResolverSoap.class, features);
    }
